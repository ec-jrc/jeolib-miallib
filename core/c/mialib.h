...
typedef struct blob { /* structure for blob analysis */
...
extern ERROR_TYPE f_framebox(IMAGE *im, int *box,  MIAFLOAT gval);
...
extern void set_shift_and_box_and_weight(unsigned char *im1, MIAFLOAT *im2, int *box, long int x, long int y, long int *shift, MIAFLOAT *weight);
