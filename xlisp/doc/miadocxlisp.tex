...
%% \item {\bf include} contains header files necessary for extending the functionalities of the C library or link it to another environment.  The key header file is named mialib.h: it contains, among many other things, the image structure definition as well as a set of 'get' and 'set' macros to get/set the values of its fields.
%% \end{itemize}
