...
%% \begin{itemize}
%% \item {\bf bin} contains executables for Linux (see mialisp) and Windows (see mialisp.exe).
...
bibtool -x mialdocxlisp.aux -r /home/soillpi/workstation/bib/clean4mmd.rsc  > mialdocxlisp.bib
