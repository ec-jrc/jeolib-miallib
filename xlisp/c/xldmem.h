...
#ifdef MIAL
/* image access macros */
#define getimage(x)     ((x)->n_info.n_image)
#endif
...
#define CONS    11      /* originally 10 mofidied for MIAL */
#ifdef COMPLX
#define COMPLEX 12      /* originally 11 mofidied for MIAL */
#endif
#ifdef BIGNUMS
#define RATIO   13      /* originally 12 mofidied for MIAL */
#endif
#define USTREAM 14      /* originally 13 mofidied for MIAL */
...
#ifdef MIAL
	IMAGE *n_image; /* image node pointer*/
#endif
...
#ifdef MIAL
extern LVAL cvimage _((IMAGE *im)); /* convert an image */
#endif
